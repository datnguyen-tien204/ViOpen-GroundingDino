...
def main(args):
    print("======== BƯỚC 0: BẮT ĐẦU CHƯƠNG TRÌNH MAIN.PY ========")
    ...
    print("======== BƯỚC 1: BẮT ĐẦU BUILD MODEL ========")
    model, criterion, postprocessors = build_model_main(args)
    wo_class_error = False
    model.to(device)
    print("======== BƯỚC 1: BUILD MODEL THÀNH CÔNG ========")
    ...
    print("======== BƯỚC 2: BẮT ĐẦU XÂY DỰNG DATASET (CÓ THỂ MẤT VÀI PHÚT) ========")
    if not args.eval:
        print("======== BƯỚC 2A: XÂY DỰNG DATASET HUẤN LUYỆN ========")
        ...
        print(f"======== BƯỚC 2A: XÂY DỰNG DATASET HUẤN LUYỆN THÀNH CÔNG ({len(dataset_train)} MẪU) ========")

    print("======== BƯỚC 2B: XÂY DỰNG DATASET VALIDATION ========")
    dataset_val = build_dataset(image_set='val', args=args, datasetinfo=dataset_meta["val"][0])
    print(f"======== BƯỚC 2B: XÂY DỰNG DATASET VALIDATION THÀNH CÔNG ({len(dataset_val)} MẪU) ========")
    ...
    print("======== BƯỚC 3: BẮT ĐẦU TẠO DATALOADER (CŨNG CÓ THỂ MẤT THỜI GIAN) ========")
    if not args.eval:
    ...
    print("======== BƯỚC 3: TẠO DATALOADER THÀNH CÔNG ========")
    ...
    if (not args.resume) and args.pretrain_model_path:
        print("======== BƯỚC 4: BẮT ĐẦU TẢI TRỌNG SỐ PRE-TRAINED ========")
        ...
        print("======== BƯỚC 4: TẢI TRỌNG SỐ PRE-TRAINED THÀNH CÔNG ========")
    ...
    print("\n\n======== TẤT CẢ ĐÃ SẴN SÀNG! BẮT ĐẦU HUẤN LUYỆN! ========\n\n")
